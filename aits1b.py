...
img2 = ClImage(file_obj=open('C:/dhu_st/2018_projects/AIOT/clarifai-python/pogo_image/pogo_image/a_30k_10.2u_27.6g_59.1mo.jpg', 'rb'))
response2 = model.predict([img2])
img3 = ClImage(file_obj=open('C:/dhu_st/2018_projects/AIOT/clarifai-python/pogo_image/pogo_image/fail_burn_pin1.jpg', 'rb'))
response2 = model.predict([img3])
img4 = ClImage(file_obj=open('C:/dhu_st/2018_projects/AIOT/clarifai-python/pogo_image/pogo_image/fail_eol3_150k.jpg', 'rb'))
response2 = model.predict([img4])
img5 = ClImage(file_obj=open('C:/dhu_st/2018_projects/AIOT/clarifai-python/pogo_image/pogo_image/fail_contamination1.jpg', 'rb'))
response2 = model.predict([img5])
img6 = ClImage(file_obj=open('C:/dhu_st/2018_projects/AIOT/clarifai-python/pogo_image/pogo_image/fail_solder_residue1.jpg', 'rb'))
response2 = model.predict([img6])
img7 = ClImage(file_obj=open('C:/dhu_st/2018_projects/AIOT/clarifai-python/pogo_image/pogo_image/fail_worn_out.jpg', 'rb'))
